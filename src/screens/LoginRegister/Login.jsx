...
function Login({ navigation }) {
    ...
    return (
        <View className="flex-1 justify-center p-5">
            ...
            <TouchableOpacity className="bg-blue-500 p-3 rounded mb-3" onPress={handleLogin}>
                <Text className="text-white text-center">Đăng nhập</Text>
            </TouchableOpacity>
            <TouchableOpacity className="bg-green-500 p-3 rounded mb-3" onPress={() => navigation.navigate('Signup')}>
                <Text className="text-white text-center">Đăng ký</Text>
            </TouchableOpacity>
            <TouchableOpacity className="bg-yellow-500 p-3 rounded mb-3" onPress={() => navigation.navigate('ForgotPW')}>
